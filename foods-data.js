...
const CATEGORIES = [
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Sour Cream (~10% fat)", lmv: "Gräddfil fett 12%", portion: 25, traits: ["allergen_milk"] },
      { name: "Sour Cream (~20% fat)", lmv: "Crème fraiche fett 34%", portion: 25, traits: ["over_10g_fat", "allergen_milk"] },
