...
const CATEGORIES = [
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Dried Fig", traits: ["fiber", "fodmaps", "polyols", "fructans", "histamine"] },
      ...
      { name: "Dried Mango (Added Sugar)", traits: ["fodmaps", "fructose", "histamine", "refined_carbs"] },
      { name: "Dried Mango (No Sugar Added)", traits: ["fodmaps", "fructose", "histamine"] },
      { name: "Dried Pineapple (Added Sugar)", traits: ["histamine", "fodmaps", "fructose", "refined_carbs"] },
      { name: "Dried Pineapple (No Sugar Added)", traits: ["histamine", "fodmaps", "fructose", "fiber"] },
      { name: "Dried Papaya (Added Sugar)", traits: ["histamine", "cross_reactive", "cross_latex", "refined_carbs"] },
      { name: "Dried Papaya (No Sugar Added)", traits: ["histamine", "cross_reactive", "cross_latex"] },
      ...
      { name: "Dried Coconut", traits: ["fiber", "over_10g_fat", "bile_stimulant", "histamine"] },
