...
const CATEGORIES = [
  {
    ...
    foods: [
      ...
      { name: "Sweet Potato", lmv: "Sötpotatis rå", portion: 175, traits: ["salicylate"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Passion Fruit", lmv: "Passionsfrukt", portion: 5, traits: ["fiber"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Dried Banana", lmv: "Banan torkad", portion: 30, traits: ["fiber", "cross_reactive", "cross_latex"] },
      { name: "Dried Apple", lmv: "Äpple torkat", portion: 30, traits: ["fiber", "fodmaps", "fructose", "polyols", "irritant", "peel_skin", "cross_reactive", "cross_birch"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Macadamia", lmv: "Macadamianötter", portion: 25, traits: ["fiber", "over_10g_fat", "bile_stimulant", "allergen", "allergen_treenut"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Common Peas", lmv: "Gröna ärtor kokta m. salt frysvara", portion: 150, traits: ["fodmaps", "fructans", "dao_competitor", "salicylate"] },
      { name: "Lentils", lmv: "Röda linser torkade kokta m. salt", lmvNote: "red lentils", portion: 150, traits: ["fiber", "fodmaps", "galactans"] },
      { name: "Tempeh", lmv: "Tempeh", portion: 125, traits: ["over_10g_fat", "allergen", "allergen_soy", "histamine"] },
      ...
      { name: "Soybeans", lmv: "Sojabönor torkade kokta u. salt", portion: 150, traits: ["fodmaps", "galactans", "allergen", "allergen_soy", "cross_reactive", "cross_birch", "dao_competitor"] },
      { name: "Edamame", lmv: "Sojabönor torkade kokta u. salt", portion: 150, traits: ["allergen", "allergen_soy", "cross_reactive", "cross_birch"] },
      { name: "Falafel", lmv: "Falafel kikärtskroketter stekta", portion: 125, traits: ["over_10g_fat", "fiber", "fodmaps", "galactans"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Egg Yolk", lmv: "Äggula rå", portion: 20, traits: ["over_10g_fat", "bile_stimulant", "allergen", "allergen_egg"] },
      ...
      { name: "Frozen Meatballs", lmv: "Köttbullar frysvara", portion: 125, traits: ["over_10g_fat", "histamine", "alpha_gal"] },
      { name: "Hot Dog Sausage", lmv: "Korv varmkorv kokt", portion: 100, traits: ["over_10g_fat", "bile_stimulant", "histamine", "alpha_gal"] },
      { name: "Chicken Nuggets", lmv: "Kyckling nugget friterad tillagad på restaurang", portion: 125, traits: ["over_10g_fat", "allergen", "allergen_wheat"] },
      { name: "Bacon", lmv: "Gris bacon stekt", portion: 20, traits: ["over_10g_fat", "bile_stimulant", "histamine", "alpha_gal", "dao_competitor"] },
      { name: "Beef Liver", lmv: "Nöt lever rå", portion: 125, traits: ["protein", "alpha_gal"] },
      { name: "Liver Pate", lmv: "Leverpastej bredbar fett ca 24%", lmvNote: "the spreadable kind, 24 % fat", portion: 20, traits: ["over_10g_fat", "bile_stimulant", "alpha_gal"] },
      { name: "Blood Pudding", lmv: "Blodpudding blodkorv fett 14%", portion: 125, traits: ["over_10g_fat", "fodmaps", "fructans", "allergen", "allergen_wheat", "alpha_gal"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Lobsters", lmv: "Hummer kokt", portion: 80, traits: ["allergen", "allergen_shellfish", "histamine"] },
      ...
      { name: "Tuna", lmv: "Tonfisk stekt m. salt", portion: 125, traits: ["bile_stimulant", "protein", "allergen", "allergen_fish", "histamine", "dao_competitor"] },
      { name: "Anchovies", lmv: "Ansjovis skarpsill konserv. ", portion: 5, traits: ["over_10g_fat", "allergen", "allergen_fish", "histamine", "dao_competitor"] },
      ...
      { name: "Fish Fingers", lmv: "Fiskpinnar stekta", portion: 125, traits: ["over_10g_fat", "allergen", "allergen_fish", "allergen_wheat", "histamine"] },
      { name: "Nori", portion: 5, traits: ["fiber"] },
      { name: "Mackerel", lmv: "Makrill rå", portion: 125, traits: ["over_10g_fat", "bile_stimulant", "histamine", "dao_competitor", "allergen", "allergen_fish"] },
      { name: "Sardines (canned)", lmv: "Sardiner i olja konserv.", portion: 20, traits: ["over_10g_fat", "bile_stimulant", "protein", "histamine", "dao_competitor", "allergen", "allergen_fish"] },
      { name: "Pickled Herring", lmv: "Sill inlagd u. lag", portion: 20, traits: ["over_10g_fat", "refined_carbs", "histamine", "dao_competitor", "irritant", "aceticAcid", "allergen", "allergen_fish"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Sour Cream (~10% fat)", lmv: "Gräddfil fett 12%", portion: 25, traits: ["over_10g_fat", "over_3g_lactose", "fodmaps", "allergen", "allergen_milk"] },
      { name: "Sour Cream (~20% fat)", lmv: "Crème fraiche fett 34%", portion: 25, traits: ["over_10g_fat", "bile_stimulant", "over_3g_lactose", "fodmaps", "allergen", "allergen_milk"] },
      { name: "Ricotta Cheese", lmv: "Färskost ricotta fett ca 10%", portion: 60, traits: ["over_10g_fat", "allergen", "allergen_milk", "over_3g_lactose"] },
      { name: "Mascarpone", lmv: "Färskost fett 33%", portion: 20, traits: ["over_10g_fat", "bile_stimulant", "allergen", "allergen_milk", "over_3g_lactose"] },
      { name: "Parmesan", lmv: "Ost hårdost parmesan fett 30% typ Parmiggiano Reggiano", portion: 20, traits: ["over_10g_fat", "bile_stimulant", "protein", "allergen", "allergen_milk", "histamine", "dao_competitor"] },
      { name: "Halloumi", lmv: "Ost halloumi rå fett 22%", portion: 60, traits: ["over_10g_fat", "bile_stimulant", "protein", "allergen", "allergen_milk"] },
      { name: "Mozzarella", lmv: "Ost mozzarella fett 18%", portion: 30, traits: ["over_10g_fat", "allergen", "allergen_milk"] },
      ...
      { name: "Camembert", lmv: "Vitmögelost camembert fett ca 22%", portion: 20, traits: ["over_10g_fat", "bile_stimulant", "allergen", "allergen_milk", "histamine", "dao_competitor"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Coconut Milk", lmv: "Kokosmjölk fett ca 6%", portion: 200, traits: ["fodmaps", "polyols"] },
  ...
  },
  {
    ...
    foods: [
      { name: "Frozen pizza", lmv: "Pizza orientalisk", portion: 175, traits: ["refined_carbs"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Quorn", lmv: "Mykoprotein bullar frysvara", lmvNote: "mycoprotein balls — plain pieces are not listed", portion: 125, traits: ["allergen", "allergen_egg"] },
      { name: "Veggie Burger (vegetable-based)", lmv: "Grönsaksburgare stekt veg.", portion: 125, traits: ["over_10g_fat", "fodmaps", "galactans", "refined_carbs"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Tzatziki", lmv: "Tzatziki", portion: 50, traits: ["over_3g_lactose", "fodmaps", "allergen", "allergen_milk"] },
      ...
      { name: "Tahini", lmv: "Tahini", portion: 25, traits: ["over_10g_fat", "bile_stimulant", "protein", "fiber", "allergen", "allergen_sesame"] },
      ...
      { name: "Peanut Butter", lmv: "Jordnötssmör", portion: 25, traits: ["fiber", "over_10g_fat", "bile_stimulant", "protein", "fodmaps", "galactans", "allergen", "allergen_peanut", "cross_reactive", "cross_grass"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Satay / Peanut Sauce", lmv: "Jordnötssås", portion: 25, traits: ["over_10g_fat", "bile_stimulant", "fodmaps", "fructans", "refined_carbs", "allergen", "allergen_peanut"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Miso Paste", lmv: "Miso sojabönspasta fermenterad", portion: 5, traits: ["over_10g_fat", "fiber", "histamine", "allergen", "allergen_soy", "fodmaps", "dao_competitor"] },
