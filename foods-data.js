...
const CATEGORIES = [
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Greek Yogurt (0% fat)", lmv: "Yoghurt naturell lätt fett 0,5% berikad", traits: ["over_3g_lactose", "fodmaps", "allergen", "allergen_milk"] },
      { name: "Greek Yogurt (2% fat)", lmv: "Yoghurt naturell fett 3% berikad", traits: ["over_3g_lactose", "fodmaps", "allergen", "allergen_milk"] },
      { name: "Greek Yogurt (10% fat)", lmv: "Yoghurt naturell fett 10%", lmvNote: "entry measures 8.3g", traits: ["over_10g_fat", "over_3g_lactose", "fodmaps", "allergen", "allergen_milk"] },
      ...
      { name: "Quark Cheese (~11% fat)", lmv: "Kvarg färskost fett 10%", lmvNote: "entry measures 10.0g", traits: ["over_10g_fat", "allergen", "allergen_milk", "over_3g_lactose"] },
