/* =========================================================================
   ...
   ADD A NEW CATEGORY
   ---------------------------------------------------------------------
   A category says which shelf you reach for the food on, not what it is
   made of. That is why dried fruit is its own category rather than fruit
   in a different state: drying changes the portion (100g of cranberries
   against 30g), the sugar in that portion (1.7g against 21.1g) and often
   the traits (sulphite arrives, salicylate sometimes goes). Cheese sits
   apart from milk for the same reason. Preparation that does none of that
   — boiled, raw, smoked — belongs in the name, not in a category.
...
const CATEGORIES = [
  {
    ...
    foods: [
      ...
      { name: "Onion", free: true, sv: "Gul lök", lmv: "Lök gul", portion: 60, traits: ["fodmaps", "fructans", "irritant", "allyl_compounds", "allergen_onion"] },
      { name: "Tomato", free: true, sv: "Tomat", form: "fresh", lmv: "Tomat", portion: 100, traits: ["histamine", "irritant", "cross_reactive", "cross_grass", "cross_latex", "dao_competitor"] },
      ...
      { name: "Avocado", free: true, sv: "Avokado", lmv: "Avokado", portion: 50, traits: ["over_10g_fat", "bile_stimulant", "cross_reactive", "cross_latex", "fodmaps", "polyols", "salicylate"] },
      ...
      { name: "Broccoli", free: true, sv: "Broccoli", lmv: "Broccoli", portion: 100, traits: ["fodmaps", "fructans"] },
  ...
  },
  {
    ...
    sv: "Frukt",
    foods: [
      { name: "Apples", free: true, sv: "Äpple", lmv: "Äpple m. skal", portion: 100, traits: ["fodmaps", "fructose", "polyols", "irritant", "peel_skin", "cross_reactive", "cross_birch", "salicylate"] },
      { name: "Oranges", free: true, sv: "Apelsin", lmv: "Apelsin", portion: 100, traits: ["cross_reactive", "cross_grass", "dao_competitor"] },
      ...
      { name: "Mangos", free: true, sv: "Mango", lmv: "Mango", portion: 100, traits: ["fodmaps", "fructose", "cross_reactive", "cross_mugwort"] },
      ...
      { name: "Banana", free: true, sv: "Banan", lmv: "Banan", portion: 100, traits: ["cross_reactive", "cross_latex", "dao_competitor"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Raisins", free: true, sv: "Russin", lmv: "Russin", portion: 30, traits: ["fodmaps", "fructans"] },
      { name: "Sultanas", sv: "Sultanrussin", lmv: "Russin", portion: 30, traits: ["fodmaps", "fructans"] },
      { name: "Dried Apricot", free: true, sv: "Torkad aprikos", lmv: "Aprikos torkad", portion: 30, traits: ["cross_reactive", "cross_birch", "fodmaps", "polyols", "fructans", "allergen_sulphite"] },
      { name: "Dried Fig", sv: "Torkat fikon", lmv: "Fikon torkade", portion: 30, traits: ["fodmaps", "polyols", "fructans"] },
      { name: "Prunes", free: true, sv: "Katrinplommon", lmv: "Katrinplommon torkade", portion: 30, traits: ["cross_reactive", "cross_birch", "fodmaps", "polyols"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Blueberry", free: true, sv: "Blåbär", lmv: "Blåbär", portion: 50, traits: [] },
      { name: "Strawberry", free: true, sv: "Jordgubbe", lmv: "Jordgubbar", portion: 50, traits: ["salicylate"] },
      ...
      { name: "Raspberries", free: true, sv: "Hallon", lmv: "Hallon", portion: 50, traits: [] },
  ...
  },
  {
    ...
    sv: "Rotfrukter",
    foods: [
      { name: "Beet Root", free: true, sv: "Rödbeta", lmv: "Rödbeta", portion: 80, traits: ["fodmaps", "fructans", "salicylate"] },
      { name: "Carrot", free: true, sv: "Morot", lmv: "Morot", portion: 80, traits: ["cross_reactive", "cross_birch", "cross_mugwort"] },
      ...
      { name: "Potato", free: true, sv: "Potatis", lmv: "Potatis rå", portion: 175, traits: ["cross_reactive", "cross_birch", "cross_grass"] },
  ...
  },
  {
    ...
    sv: "Svamp",
    foods: [
      { name: "Shiitake Mushrooms", free: true, sv: "Shiitakesvamp", form: "fresh", lmv: "Shiitakesvamp", portion: 80, traits: ["fodmaps", "polyols", "dao_competitor", "allergen_mushroom"] },
      { name: "Oyster Mushrooms", sv: "Ostronskivling", form: "fresh", lmv: "Ostronskivling", portion: 80, traits: ["dao_competitor", "allergen_mushroom"] },
      { name: "White Button Mushrooms", free: true, sv: "Champinjon", form: "fresh", lmv: "Champinjon", portion: 80, traits: ["fodmaps", "polyols", "dao_competitor", "allergen_mushroom"] },
      ...
      { name: "Chanterelle Mushrooms", free: true, sv: "Kantarell", form: "fresh", lmv: "Kantarell gul rå", portion: 80, traits: ["fodmaps", "polyols", "dao_competitor", "allergen_mushroom"] },
  ...
  },
  {
    ...
    foods: [
      { name: "Oats", free: true, sv: "Havre", form: "dry", lmv: "Havregryn fullkorn", portion: 40, traits: ["fodmaps", "fructans", "allergen_wheat"] },
      ...
      { name: "Wheat", free: true, sv: "Vete", form: "cooked", lmv: "Matvete kokt m. salt", portion: 175, traits: ["fiber", "fodmaps", "fructans", "allergen_wheat"] },
      { name: "Rye", free: true, sv: "Råg", form: "dry", lmv: "Rågkross ångprep. fullkorn", lmvNote: "cracked whole grain, dry weight — rye is not listed cooked", portion: 60, traits: ["fiber", "fodmaps", "fructans", "allergen_wheat"] },
      ...
      { name: "Rice", free: true, sv: "Ris", form: "cooked", lmv: "Ris råris kokt m. salt", portion: 175, traits: [] },
  ...
  },
  {
    ...
    sv: "Nötter och frön",
    foods: [
      { name: "Almond", free: true, sv: "Mandel", lmv: "Sötmandel", portion: 25, traits: ["over_10g_fat", "bile_stimulant", "fodmaps", "galactans", "salicylate", "allergen_treenut", "cross_reactive", "cross_birch"] },
      ...
      { name: "Peanut", free: true, sv: "Jordnöt", lmv: "Jordnötter torkade", portion: 25, traits: ["over_10g_fat", "bile_stimulant", "fodmaps", "galactans", "allergen_peanut", "cross_reactive", "cross_grass"] },
      ...
      { name: "Walnut", free: true, sv: "Valnöt", lmv: "Valnötter", portion: 25, traits: ["over_10g_fat", "bile_stimulant", "allergen_treenut"] },
      { name: "Sesame Seeds", free: true, sv: "Sesamfrön", lmv: "Sesamfrö m. skal", portion: 5, traits: ["allergen_sesame"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Chickpea (whole/flour)", free: true, sv: "Kikärtor (hela/mjöl)", form: "cooked", lmv: "Kikärtor torkade kokta m. salt", portion: 150, traits: ["fiber", "fodmaps", "galactans"] },
      ...
      { name: "Lentils", free: true, sv: "Linser", form: "cooked", lmv: "Röda linser torkade kokta m. salt", lmvNote: "red lentils", portion: 150, traits: ["fiber", "protein", "fodmaps", "galactans"] },
      { name: "Tempeh", sv: "Tempeh", lmv: "Tempeh", portion: 125, traits: ["over_10g_fat", "bile_stimulant", "protein", "histamine", "allergen_soy"] },
      { name: "Tofu (firm)", free: true, sv: "Tofu (fast)", lmv: "Tofu fast", portion: 125, traits: ["allergen_soy", "cross_reactive", "cross_birch", "dao_competitor"] },
  ...
  },
  {
    ...
    foods: [
      { name: "Rye Bread (whole grain)", free: true, sv: "Rågbröd (fullkorn)", lmv: "Bröd fullkorn råg fibrer ca 7%", portion: 40, traits: ["fodmaps", "fructans", "allergen_wheat"] },
      ...
      { name: "White Bread", free: true, sv: "Vitt bröd", lmv: "Bröd vitt fibrer 3,5%", portion: 40, traits: ["allergen_wheat", "fodmaps", "fructans", "refined_carbs"] },
      { name: "Pasta (no egg)", free: true, sv: "Pasta (utan ägg)", form: "cooked", lmv: "Pasta kokt u. salt", portion: 175, traits: ["refined_carbs", "allergen_wheat", "fodmaps", "fructans"] },
  ...
  },
  {
    ...
    sv: "Ost",
    foods: [
      { name: "Cream Cheese (<10% fat)", free: true, sv: "Färskost (<10 % fett)", lmv: "Färskost cream cheese extra light fett 5%", portion: 20, traits: ["allergen_milk"] },
      ...
      { name: "Hard Cheese (~28-35% fat)", free: true, sv: "Hårdost (~28–35 % fett)", lmv: "Ost hårdost fett 31%", portion: 20, traits: ["over_10g_fat", "histamine", "dao_competitor", "allergen_milk"] },
      ...
      { name: "Parmesan", free: true, sv: "Parmesan", lmv: "Ost hårdost parmesan fett 30% typ Parmiggiano Reggiano", portion: 20, traits: ["over_10g_fat", "histamine", "dao_competitor", "allergen_milk"] },
      ...
      { name: "Blue Cheese", free: true, sv: "Ädelost", lmv: "Ädelost grönmögelost fett 17%", portion: 20, traits: ["histamine", "dao_competitor", "allergen_milk"] },
  ...
  },
  {
    ...
    foods: [
      { name: "Salmon", free: true, sv: "Lax", lmv: "Lax stekt m. salt", portion: 125, traits: ["over_10g_fat", "bile_stimulant", "protein", "allergen_fish", "histamine", "dao_competitor"] },
      { name: "Cod", free: true, sv: "Torsk", lmv: "Torsk rå", portion: 125, traits: ["protein", "histamine", "allergen_fish"] },
      ...
      { name: "Shrimp", free: true, sv: "Räka", lmv: "Räka kokt", portion: 80, traits: ["allergen_crustacean", "histamine"] },
      ...
      { name: "Mussels", free: true, sv: "Musslor", lmv: "Mussla konserv. m. lag", portion: 80, traits: ["allergen_mollusc", "histamine"] },
  ...
  },
  {
    ...
    foods: [
      { name: "Cows Meat", free: true, sv: "Nötkött", lmv: "Nöt kött rå", portion: 125, traits: ["bile_stimulant", "protein", "alpha_gal"] },
      ...
      { name: "Chicken", free: true, sv: "Kyckling", lmv: "Kyckling kokt m. salt", portion: 125, traits: ["bile_stimulant", "protein"] },
      ...
      { name: "Whole Egg", free: true, sv: "Helt ägg", lmv: "Ägg rått", portion: 50, traits: ["allergen_egg"] },
  ...
  },
  {
    ...
    foods: [
      { name: "Cows Milk (3% fat)", free: true, sv: "Komjölk (3 % fett)", lmv: "Mjölk fett 3% berikad", portion: 200, traits: ["over_3g_lactose", "fodmaps", "allergen_milk"] },
      ...
      { name: "Yogurt (3% fat)", free: true, sv: "Yoghurt (3 % fett)", lmv: "Yoghurt naturell fett 3% berikad", portion: 200, traits: ["over_3g_lactose", "fodmaps", "allergen_milk"] },
      ...
      { name: "Cream (40% fat)", free: true, sv: "Grädde (40 % fett)", lmv: "Vispgrädde fett 40%", portion: 25, traits: ["over_10g_fat", "bile_stimulant", "allergen_milk"] },
  ...
  },
  {
    ...
    sv: "Inälvsmat",
    foods: [
      { name: "Beef Liver", free: true, sv: "Nötlever", lmv: "Nöt lever rå", portion: 125, traits: ["protein", "alpha_gal"] },
      { name: "Liver Pate", free: true, sv: "Leverpastej", lmv: "Leverpastej bredbar fett ca 24%", lmvNote: "the spreadable kind, 24 % fat", portion: 20, traits: ["alpha_gal"] },
      { name: "Blood Pudding", free: true, sv: "Blodpudding", lmv: "Blodpudding blodkorv fett 14%", portion: 125, traits: ["over_10g_fat", "bile_stimulant", "fodmaps", "fructans", "allergen_wheat", "alpha_gal"] },
  ...
  },
  {
    ...
    sv: "Chark och korv",
    foods: [
      { name: "Salami", free: true, sv: "Salami", lmv: "Påläggskorv salami rökt", portion: 20, traits: ["over_10g_fat", "histamine", "dao_competitor", "alpha_gal"] },
      ...
      { name: "Hot Dog Sausage", free: true, sv: "Varmkorv", lmv: "Korv varmkorv kokt", portion: 100, traits: ["over_10g_fat", "bile_stimulant", "histamine", "alpha_gal"] },
      ...
      { name: "Bacon", free: true, sv: "Bacon", lmv: "Gris bacon stekt", portion: 20, traits: ["over_10g_fat", "histamine", "dao_competitor", "alpha_gal"] },
  ...
  },
  {
    ...
    foods: [
      { name: "Chili (fresh)", free: true, sv: "Chili (färsk)", bothWays: true, form: "fresh", lmv: "Chilipeppar färsk", portion: 5, traits: ["irritant", "capsaicin"] },
      { name: "Garlic", free: true, sv: "Vitlök", form: "fresh", lmv: "Vitlök", portion: 5, traits: ["fodmaps", "fructans", "irritant", "allyl_compounds", "allergen_onion"] },
      ...
      { name: "Mustard", free: true, sv: "Senap", lmv: "Senap svensk", portion: 5, traits: ["irritant", "allyl_compounds", "allergen_mustard", "cross_reactive", "cross_mugwort"] },
      { name: "Black Pepper", free: true, sv: "Svartpeppar", form: "dried", portion: 2, traits: ["irritant", "cross_reactive", "cross_mugwort"] },
  ...
  /* THREE GROUPS, ONE QUESTION EACH. Condiments, Sauces and Dips used to
    ...
    sv: "Smaksättare",
    foods: [
      { name: "Salt", free: true, sv: "Salt", lmv: "Salt m. jod", portion: 5, traits: [] },
      { name: "Vinegar", free: true, sv: "Ättika", portion: 5, traits: ["aceticAcid", "irritant"] },
      ...
      { name: "Soy Sauce", free: true, sv: "Soja", lmv: "Sojasås", portion: 5, traits: ["histamine", "allergen_soy", "allergen_wheat", "dao_competitor"] },
  ...
  },
  {
    ...
    foods: [
      { name: "Ketchup", free: true, sv: "Ketchup", lmv: "Ketchup", portion: 25, traits: ["aceticAcid", "irritant", "dao_competitor"] },
      { name: "Mayonnaise", free: true, sv: "Majonnäs", lmv: "Majonnäs fett 80%", portion: 25, traits: ["over_10g_fat", "bile_stimulant", "allergen_egg"] },
      ...
      { name: "Bechamel Sauce", free: true, sv: "Bechamelsås", lmv: "Béchamelsås", portion: 60, traits: ["allergen_milk", "allergen_wheat"] },
  ...
  },
  {
    ...
    sv: "Röror",
    foods: [
      { name: "Hummus", free: true, sv: "Hummus", lmv: "Hummus kikärtsröra", portion: 50, traits: ["over_10g_fat", "bile_stimulant", "fodmaps", "galactans", "allergen_sesame"] },
      { name: "Guacamole", free: true, sv: "Guacamole", lmv: "Guacamole", portion: 50, traits: ["over_10g_fat", "cross_reactive", "cross_latex"] },
      { name: "Baba Ganoush", sv: "Baba ganoush", portion: 50, traits: ["histamine"] },
      { name: "Tahini", free: true, sv: "Tahini", lmv: "Tahini", portion: 25, traits: ["over_10g_fat", "bile_stimulant", "allergen_sesame"] },
  ...
  },
  {
    ...
    sv: "Söta pålägg",
    foods: [
      { name: "Chocolate Spread (hazelnut)", free: true, sv: "Chokladpålägg (hasselnöt)", portion: 20, traits: ["over_10g_fat", "refined_carbs", "allergen_milk", "allergen_treenut"] },
      ...
      { name: "Strawberry Jam", free: true, sv: "Jordgubbssylt", portion: 20, traits: ["refined_carbs", "cross_reactive", "cross_birch"] },
      ...
      { name: "Orange Marmalade", free: true, sv: "Apelsinmarmelad", portion: 20, traits: ["refined_carbs", "cross_reactive", "cross_grass"] }
    ]
  },
  {
    id: "picklesFerments",
    ...
    foods: [
      ...
      { name: "Sauerkraut", free: true, sv: "Surkål", lmv: "Surkål konserv. m. lag", portion: 50, traits: ["histamine", "dao_competitor"] },
      { name: "Pickled Cucumber", free: true, sv: "Inlagd gurka", lmv: "Gurka inlagd", portion: 25, traits: ["histamine", "aceticAcid", "irritant"] },
      { name: "Olives", free: true, sv: "Oliver", lmv: "Oliver gröna m. paprikafyllning avrunna", portion: 25, traits: ["histamine"] },
  ...
  },
  {
    ...
    sv: "Fetter och oljor",
    foods: [
      { name: "Butter", free: true, sv: "Smör", lmv: "Smör fett 80%", portion: 10, traits: ["over_10g_fat", "allergen_milk"] },
      { name: "Margarine", free: true, sv: "Margarin", lmv: "Flytande margarin fett 70%", portion: 10, traits: ["over_10g_fat"] },
      { name: "Sesame Oil", sv: "Sesamolja", lmv: "Sesamolja", portion: 10, traits: ["over_10g_fat", "bile_stimulant", "allergen_sesame"] },
      { name: "Olive Oil", free: true, sv: "Olivolja", lmv: "Olivolja", portion: 10, traits: ["over_10g_fat", "bile_stimulant"] },
  ...
  },
  {
    ...
    sv: "Sötningsmedel",
    foods: [
      { name: "Honey", free: true, sv: "Honung", lmv: "Honung", portion: 25, traits: ["fodmaps", "fructose", "fructans"] },
      { name: "White Sugar", free: true, sv: "Vitt socker", lmv: "Socker", portion: 5, traits: ["refined_carbs"] },
      { name: "Maple Syrup", free: true, sv: "Lönnsirap", portion: 25, sugarsOfCarbs: 0.9, traits: ["refined_carbs"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Milk chocolate", free: true, sv: "Mjölkchoklad", lmv: "Mjölkchoklad", portion: 30, traits: ["irritant", "over_10g_fat", "bile_stimulant", "refined_carbs", "over_3g_lactose", "fodmaps", "caffeine", "allergen_milk"] },
      { name: "Dark Chocolate", free: true, sv: "Mörk choklad", lmv: "Mörk choklad kakao ≥ 70%", portion: 25, traits: ["irritant", "over_10g_fat", "bile_stimulant", "refined_carbs", "caffeine"] },
      ...
      { name: "Liquorice", free: true, sv: "Lakrits", lmv: "Lakritsgodis", portion: 30, traits: ["refined_carbs"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Coffee", free: true, sv: "Kaffe", lmv: "Kaffe bryggt", portion: 200, traits: ["caffeine", "irritant"] },
      { name: "Espresso", sv: "Espresso", lmv: "Kaffe espresso bryggt drickf.", portion: 30, traits: ["caffeine", "irritant"] },
      { name: "Black Tea", free: true, sv: "Svart te", portion: 200, traits: ["caffeine", "irritant"] },
      ...
      { name: "Cola", free: true, sv: "Cola", lmv: "Läsk cola", portion: 330, traits: ["caffeine", "refined_carbs", "carbonation", "irritant"] }
    ]
  },
  {
    id: "bakedDesserts",
    ...
    foods: [
      ...
      { name: "Ice Cream", free: true, sv: "Glass", lmv: "Glass fett ca 10%", portion: 100, traits: ["over_10g_fat", "bile_stimulant", "refined_carbs", "over_3g_lactose", "fodmaps", "allergen_milk"] },
      { name: "Baklava", sv: "Baklava", lmv: "Baklava ", portion: 40, traits: ["over_10g_fat", "refined_carbs", "allergen_wheat", "allergen_treenut"] },
      { name: "Cinnamon Bun", free: true, sv: "Kanelbulle", lmv: "Sött vetebröd kanelbulle gräddad kylvara frysvara el. butiksbakad", lmvNote: "the 18.5 g of sugar is nearly all sucrose — the milk in the dough leaves well under a gram of lactose", portion: 60, traits: ["over_10g_fat", "refined_carbs", "fodmaps", "fructans", "allergen_milk", "allergen_wheat"] },
      ...
      { name: "Digestive Biscuit", free: true, sv: "Digestivekex", lmv: "Kex digestive fullkorn 23%", portion: 30, traits: ["refined_carbs", "allergen_wheat"] },
  ...
  },
  {
    ...
    foods: [
      { name: "Red Wine", free: true, sv: "Rödvin", lmv: "Vin rött vol. % 14", portion: 150, traits: ["alcohol", "histamine", "irritant", "allergen_sulphite"] },
      ...
      { name: "Beer", free: true, sv: "Öl", lmv: "Öl starköl el. exportöl vol. % 5,4", portion: 330, traits: ["alcohol", "histamine", "irritant", "carbonation", "allergen_wheat"] },
      ...
      { name: "Spirits (Liquor)", free: true, sv: "Sprit", lmv: "Whisky vol. % 40", portion: 40, traits: ["alcohol", "irritant", "histamine"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Soy Milk", free: true, sv: "Sojadryck", lmv: "Sojadryck", portion: 200, traits: ["allergen_soy", "fodmaps", "galactans", "dao_competitor"] },
      { name: "Oat Drink", free: true, sv: "Havredryck", lmv: "Havredryck fett 1,5% berikad", portion: 200, traits: ["allergen_wheat"] },
      ...
      { name: "Quorn", free: true, sv: "Quorn", lmv: "Mykoprotein bullar frysvara", lmvNote: "mycoprotein balls — plain pieces are not listed", portion: 125, traits: ["protein", "allergen_egg", "allergen_mushroom"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Potato chips", free: true, sv: "Potatischips", lmv: "Chips potatis naturell", portion: 30, traits: ["over_10g_fat"] },
      ...
      { name: "Savoury Crackers", free: true, sv: "Salta kex", lmv: "Kex salta", portion: 20, traits: ["refined_carbs", "allergen_wheat"] },
      ...
      { name: "Salted Roasted Peanuts", free: true, sv: "Saltade rostade jordnötter", lmv: "Jordnötter rostade saltade", portion: 25, traits: ["over_10g_fat", "bile_stimulant", "fodmaps", "galactans", "allergen_peanut", "cross_reactive", "cross_grass"] },
  ...
  },
  {
    ...
    sv: "Färdigmat",
    foods: [
      { name: "Frozen pizza", free: true, sv: "Fryst pizza", lmv: "Pizza orientalisk", portion: 175, traits: ["over_10g_fat", "bile_stimulant", "protein", "refined_carbs"] },
      { name: "French Fries (deep-fried)", free: true, sv: "Pommes frites (frityrkokta)", lmv: "Pommes frites friterad potatis fett ca 11% frysvara", portion: 150, traits: ["over_10g_fat", "bile_stimulant", "refined_carbs"] },
      ...
      { name: "Instant Soup / Bouillon Cubes", free: true, sv: "Snabbsoppa / buljongtärningar", form: "cooked", lmv: "Köttbuljong tärning ätf.", lmvNote: "ready-to-eat broth, not the dry cube", portion: 200, traits: ["fodmaps", "fructans", "allergen_celery"] },
...
const CATEGORY_GROUPS = [
  {
    ...
    categories: ["veggies", "fruits", "driedFruits", "berries", "roots", "mushrooms"]
  },
  {
    title: "Grains, Nuts & Legumes", sv: "Spannmål, nötter & baljväxter",
    categories: ["grains", "nuts", "legumes", "bread"]
  },
  {
  ...
  },
  {
    ...
    categories: ["confectionery", "softDrinks", "bakedDesserts", "alcohol", "plantBased", "savourySnacks", "readyMeals"]
  }
];
