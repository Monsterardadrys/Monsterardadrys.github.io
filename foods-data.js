...
const CATEGORIES = [
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Beef Liver", lmv: "Nöt lever rå", traits: ["alpha_gal"] },
  ...
  },
  {
    ...
    foods: [
      ...
      { name: "Veggie Burger (bean-based)", lmv: "Grönsaksburgare stekt veg.", traits: ["fiber", "fodmaps", "galactans", "refined_carbs"] },
