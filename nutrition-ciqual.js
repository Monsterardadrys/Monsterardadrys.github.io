...
const NUTRITION_CIQUAL = {
  "Butter Beans": {
    src: "ciqual", ref: "Butter bean or yellow bean, boiled/cooked in water (Ciqual 20318)",
    values: { fat: 0.3, protein: 2.19, carbs: 4.45, fiber: 2.7, sugars: 2.2, alcohol: 0, water: 89.6 }
  },
  "Corn Tortilla": {
    src: "ciqual", ref: "Maize/corn tortilla wrap, to be filled (Ciqual 7813)",
    values: { fat: 5.57, protein: 6.08, carbs: 58, fiber: 3.57, sugars: 2.37, alcohol: 0, water: 26 }
  },
  "Harissa": {
    src: "ciqual", ref: "Harissa (hot spicy sauce), prepacked (Ciqual 11112)",
    values: { fat: 2.9, protein: 2.72, carbs: 7.3, fiber: 5.1, sugars: 6.89, alcohol: 0, water: 77.9 }
  },
  "Kombucha": {
    src: "ciqual", ref: "Kombucha, prepacked (Ciqual 18025) [fat below 0,3, fiber below 0,5]",
    values: { fat: 0, protein: 0.25, carbs: 1.45, fiber: 0, sugars: 1.45, alcohol: 0, water: 97.6 }
  },
  "Raclette": {
    src: "ciqual", ref: "Raclette cheese, from cow's milk (Ciqual 12749) [carbs traces, sugars traces]",
    values: { fat: 27.5, protein: 23.4, carbs: 0, fiber: 0, sugars: 0, alcohol: 0, water: 44.7 }
  },
  "Teriyaki Sauce": {
    src: "ciqual", ref: "Teriyaki sauce, prepacked (Ciqual 11301)",
    values: { fat: 0.02, protein: 5.93, carbs: 16, fiber: 0.1, sugars: 14.1, alcohol: 0, water: 67.7 }
  }
};
