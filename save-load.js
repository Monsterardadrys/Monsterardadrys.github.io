/* =========================================================================
   ...
   be silently loaded into another.
   ========================================================================= */
...
const SaveLoad = (function () {
  ...
  function save(tool, payload, basename) {
    const data = Object.assign({ app: APP, tool: tool, version: FORMAT, saved: new Date().toISOString() }, payload);
  ...
  // Opens the file picker. `done(data)` on success, `fail(message)` on a file
